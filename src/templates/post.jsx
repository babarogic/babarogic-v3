...
const Post = ({ post, meta }) => {
    return (
        <>
            <Helmet
                title={`${post.post_title[0].text} | Goran Babarogic UX Designer & Front End Developer`}
                ...
                meta={[
                    ...
                    {
                        property: `og:title`,
                        content: `${post.post_title[0].text} | Goran Babarogic UX Designer & Front End Developer`,
                    },
                    {
